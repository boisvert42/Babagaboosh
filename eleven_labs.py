...
_config.read(_pth)
ELEVENLABS_API_KEY = _config['ElevenLabs']['API_KEY']
set_api_key(ELEVENLABS_API_KEY)

DEFAULT_VOICE = 'Dorothy'
...
if __name__ == '__main__':
    ...
    #elevenlabs_manager.text_to_audio_streamed("This is my streamed test audio, I'm so much cooler than played", "Dorothy")
    #time.sleep(2)
    elevenlabs_manager.text_to_audio_played("This is my played test audio, hello hello", DEFAULT_VOICE)
    time.sleep(2)
    file_path = elevenlabs_manager.text_to_audio("This is my saved test audio, please make me beautiful", DEFAULT_VOICE)
